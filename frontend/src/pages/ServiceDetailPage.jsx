...
const MOCK_SERVICES = {
  ...
  2: { id: 2, icon: '🖨️', title: 'طباعة وتجليد المذكرات', description: 'خدمة طباعة احترافية لمذكرات التخرج والوثائق الجامعية. طباعة ملونة وبالأبيض والأسود، تجليد صلب أو ناعم، توصيل داخل الحرم الجامعي.', category: 'academic', price: '150 د', rating: '4.7', reviews: 38, provider: 'مكتبة النجاح', provider_role: 'مزود خدمة', phone: '+213 555 789 012', available: true },
  5: { id: 5, icon: '🏠', title: 'غرفة مفروشة شارع الجامعة', description: 'غرفة مفروشة بالكامل في شقة مشتركة على بعد 5 دقائق من الحرم الجامعي. تشمل: سرير، مكتب، خزانة. مرافق مشتركة (مطبخ، حمام). انترنت مجاني.', category: 'stability', price: '8,000 د/شهر', rating: '4.6', reviews: 15, provider: 'حسين مالكي', provider_role: 'مالك', phone: '+213 555 456 789', available: true },
  8: { id: 8, icon: '🚌', title: 'حافلة يومية الجامعة', description: 'خدمة النقل اليومي من المدينة إلى الحرم الجامعي. مواعيد الذهاب: 7:30 و 8:30 صباحاً. مواعيد العودة: 16:30 و 18:00. ممتد لجميع أيام الدراسة.', category: 'welfare', price: '200 د/يوم', rating: '4.9', reviews: 64, provider: 'شركة النقل الجامعي', provider_role: 'مزود خدمة', phone: '+213 555 321 654', available: true },
}
